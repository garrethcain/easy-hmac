...
class TestEasyHmac(unittest.TestCase):
    ...
    def compute_dummy_request(self, token, body, a_timestamp):
        """
    ...
    def test_verify_hmac_malformed_timestamp(self):
        ...
        request = self.compute_dummy_request(self.token, "", malformed_timestamp)
        body = request["body"]
        headers = request["headers"]
        path = request["path"]
        method = request["method"]
    ...
    def test_verify_hmac_timestamp_too_old(self):
        ...
        request = self.compute_dummy_request(self.token, "", old_timestamp)
        body = request["body"]
        headers = request["headers"]
        path = request["path"]
        method = request["method"]
    ...
    def test_generate_hmac(self):
        ...
        expected_signature = "0dKZk1RdhvdMP6aDZyltwiWoAiEW3P32p0ihMts2K6o="  # SLtkg8653hvTwT0onBWI47vky0O65kkL99XN/cUskXc="
        self.assertEqual(
            expected_signature,
            actual_signature,
